...
public abstract class Constante implements Serializable {
    ...
    public static final String SUPPRESION_IMPOSSIBLE = "Suppression impossible, l'Objet est utilisée dans une association";
     public static final String PLANNING_INNEXISTANT = "Il n'existe pas de plannings pour la vague sélectionnée";
